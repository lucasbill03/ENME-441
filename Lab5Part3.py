...
try:
	while True:
		...
		B = (math.sin(2 * math.pi * f * t_actual - 2*phi)**2)
		duty_cycle3 = B * 100.0

		# Pin 4 duty cycle changing
		B = (math.sin(2 * math.pi * f * t_actual - 3*phi)**2)
		duty_cycle4 = B * 100.0

		# Pin 5 duty cycle changing
		B = (math.sin(2 * math.pi * f * t_actual - 4*phi)**2)
		duty_cycle5 = B * 100.0

		# Pin 6 duty cycle changing
		B = (math.sin(2 * math.pi * f * t_actual - 5*phi)**2)
		duty_cycle6 = B * 100.0

		# Pin 7 duty cycle changing
		B = (math.sin(2 * math.pi * f * t_actual - 6*phi)**2)
		duty_cycle7 = B * 100.0

		# Pin 8 duty cycle changing
		B = (math.sin(2 * math.pi * f * t_actual - 7*phi)**2)
		duty_cycle8 = B * 100.0

		# Pin 9 duty cycle changing
		B = (math.sin(2 * math.pi * f * t_actual - 8*phi)**2)
		duty_cycle9 = B * 100.0

		# Pin 10 duty cycle changing
		B = (math.sin(2 * math.pi * f * t_actual - 9*phi)**2)
